...
# solves for harmonics of \nabla^2 on a square domain containing a non-centred square hole
# problem combines non-trivial cohomology and re-entrant corners
...
File("eigenvalue_problem_square_vortex_u.pvd").write(eigenmode)
