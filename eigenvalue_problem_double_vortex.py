...
# solves for harmonics of \nabla^2 on a domain with two circular holes
...
lam = es.getEigenpair(0, vr, vi)  #modes 0 and 1 span cohomology space - choose mode here
...
File("eigenvalue_problem_double_vortex_u.pvd").write(eigenmode)
